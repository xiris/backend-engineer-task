...
- The main programming langauge is Ruby
- We expect that you will not use any big frameworks like Rails, because we want to understand how you will structure your code
- You can use any library you want to avoid overengineering (for tests, database connection and mapping, etc)
- Please ensure that you follow the syntax and formatting of both the input and output samples.
...
- When implementing this solution, please use a version control system of your choice that works on Linux and OSX. We expect you to send us a zip/tarball or a git bundle of your source code when you're done that includes the VCS metadata so we can look at your commit logs and understand how your solution evolved.
...
- Send us an email at tech@getgrover.com (and cc andreaboada@getgrover.com) with subject "Submit - Backend Coding Challenge" Include the repository link to your submission in the email.

- For queries, shoot us an email at tech@getgrover.com
...
Output (could be a console or a file):
```
